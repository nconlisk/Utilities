...
def extractImages(pathIn, pathOut, filename):
    ...
    while success:
        ...
        if frameID%selector==0:
            ...
            cv2.imwrite(newFolder + "\\frame%d.jpg" % frameID, image)     # save frame as JPEG file
            count += 1
    print('Number of images generated: %d'%count)

if __name__=="__main__":
    filename = input("Enter video file including extension to be reconstructed: ")
    path = os.getcwd()
